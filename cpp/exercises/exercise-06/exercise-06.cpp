...
void update_users_state(struct Player *stop_playing, struct Player *start_player) {
    stop_playing->playing = false;
    start_player->playing = true;
}
...
int main() {
    ...
    do {
        ...
        if (ptr_player1->playing) {
            ...
            update_users_state(ptr_player1, ptr_player2);
        } else {
            play(ptr_player2, game_board);
            update_users_state(ptr_player2, ptr_player1);
        }
